...
# Simulate the process 10,000 times
...
ggplot(sim_results_df, aes(x = diff)) +
  ...
  labs(title = "Distribution of Treatment/Control Balance Across 10,000 Simulations",
       x = "Difference in Male Proportion (Treatment - Control)",
       y = "Frequency") +
  theme_minimal()
